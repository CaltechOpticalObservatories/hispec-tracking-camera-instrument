  ...
  const std::vector<HeaderDictEntry>& fits_header_dictionary() {
    ...
    static const std::vector<HeaderDictEntry> dictionary = {
      ...
      { "operational_mode", "OPSMODE", "Operational mode, e.g. freerun or autofetch",
        Type::String, "", "", {} },
      { "exposure_time", "EXPTIME", "[sec] Effective exposure time",
        Type::Number, "", "0", {} },
      // Constant because the exposure time is held in seconds whatever unit
      // LONGEXPOSURE has the exptime command accept
      { "exposure_time_unit", "EXPTUNIT", "Unit of EXPTIME",
        Type::String, "sec", "sec", {} },
      ...
      { "file_type", "FILETYPE", "Type of file",
        Type::String, "FITS", "FITS", {"FITS"} },
      { "LVLC_V1", "LVLC_V1", "[volts] Gate voltage",
        Type::Number, "from ACF", "", {} },
      { "LVLC_V2", "LVLC_V2", "[volts] Bias power",
        Type::Number, "from ACF", "", {} },
      { "LVLC_V3", "LVLC_V3", "[volts] Diode substrate voltage",
        Type::Number, "from ACF", "", {} },
      ...
      { "nskip_lines", "SKIPLNES", "Number of lines skipped",
        Type::Integer, "", "", {} },
      { "n_reads", "NREADS", "Number of reads in series or datacube",
        Type::Integer, "", "", {} },
